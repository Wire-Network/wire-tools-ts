...
- If touching flow behavior, preserve Report evidence and the canonical runner contract; report all failed swap-stress invariants together, and treat simulation-time cluster-log evidence as a supporting cause rather than an incident-specific outcome.
