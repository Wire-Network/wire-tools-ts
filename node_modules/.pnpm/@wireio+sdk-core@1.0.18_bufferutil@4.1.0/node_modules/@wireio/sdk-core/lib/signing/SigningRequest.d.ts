...
import { ABISerializable, ABISerializableConstructor, ABISerializableType } from "../serializer/Serializable";
import { Action, AnyAction } from "../chain/Action";
import { AnyTransaction, Transaction, TransactionExtension } from "../chain/Transaction";
import { AuthorityType } from "../chain/Authority";
...
import { ChainId, ChainIdType } from "./ChainId";
...
export declare class SigningRequest {
    ...
    getRawInfoKey(key: string): Bytes;
 ...
 * IDENTITY PROOF ts
 */
export type IdentityProofType = IdentityProof | string | {
    chainId: ChainIdType;
    scope: NameType;
    expiration: TimePointType;
