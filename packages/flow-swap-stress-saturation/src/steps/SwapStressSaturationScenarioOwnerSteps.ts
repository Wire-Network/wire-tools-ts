 ...
 */
export namespace SwapStressSaturationScenarioOwnerSteps {
  ...
  export interface ProvisionOwnerInput extends StepInput {
    readonly kind: "SwapStressSaturationScenarioOwnerSteps.ProvisionOwnerInput"
  ...
  >(
    ...
    return ClusterBuildStep.create<C, ProvisionOwnerInput>(
      ...
      options,
      {
        kind: "SwapStressSaturationScenarioOwnerSteps.ProvisionOwnerInput",
  ...
  export interface LinkOwnerInput extends StepInput {
    readonly kind: "SwapStressSaturationScenarioOwnerSteps.LinkOwnerInput"
    /** The owner WIRE account name. */
    readonly account: string
  ...
  >(
    ...
    return ClusterBuildStep.create<C, LinkOwnerInput>(
      ...
      options,
      {
        kind: "SwapStressSaturationScenarioOwnerSteps.LinkOwnerInput",
        account: Constants.Accounts.Owner,
        chainKind
      },
      runLinkOwner
  ...
  export interface MintCreatorUsdcSolInput extends StepInput {
    readonly kind: "SwapStressSaturationScenarioOwnerSteps.MintCreatorUsdcSolInput"
  ...
  >(
    ...
    return ClusterBuildStep.create<C, MintCreatorUsdcSolInput>(
      ...
      options,
      {
        kind: "SwapStressSaturationScenarioOwnerSteps.MintCreatorUsdcSolInput",
