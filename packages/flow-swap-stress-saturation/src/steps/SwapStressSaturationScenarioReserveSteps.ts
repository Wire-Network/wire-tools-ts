 ...
 */
export namespace SwapStressSaturationScenarioReserveSteps {
  ...
  export interface CreateEthereumReserveInput extends StepInput {
    readonly kind: "SwapStressSaturationScenarioReserveSteps.CreateEthereumReserveInput"
  ...
  >(
    ...
    return ClusterBuildStep.create<C, CreateEthereumReserveInput>(
      ...
      options,
      {
        kind: "SwapStressSaturationScenarioReserveSteps.CreateEthereumReserveInput",
  ...
  export interface CreateSolanaReserveInput extends StepInput {
    readonly kind: "SwapStressSaturationScenarioReserveSteps.CreateSolanaReserveInput"
    readonly tokenCode: number
    readonly reserveCode: number
  ...
  >(
    ...
    return ClusterBuildStep.create<C, CreateSolanaReserveInput>(
      ...
      options,
      {
        kind: "SwapStressSaturationScenarioReserveSteps.CreateSolanaReserveInput",
  ...
  export interface MatchReserveInput extends StepInput {
    readonly kind: "SwapStressSaturationScenarioReserveSteps.MatchReserveInput"
  ...
  >(
    ...
    return ClusterBuildStep.create<C, MatchReserveInput>(
      ...
      options,
      {
        kind: "SwapStressSaturationScenarioReserveSteps.MatchReserveInput",
        chainCode,
        tokenCode,
        reserveCode: Constants.Reserves.PrivateReserveCode,
