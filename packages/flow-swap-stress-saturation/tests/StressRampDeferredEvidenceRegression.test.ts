...
import type { OppStressRampDeferredEvidenceIterationObservation } from "@wireio/test-flow-swap-stress-saturation/stress-engine/index.js"
...
} from "@wireio/test-flow-swap-stress-saturation/stress-engine/rampControllerTypes.js"
...
function compilerConfig(fixturePath: string): string {
  return JSON.stringify({
    compilerOptions: {
      ...
      paths: {
        "@wireio/test-flow-swap-stress-saturation/stress-engine/rampControllerTypes.js": [
          "src/stress-engine/rampControllerTypes.ts"
        ],
