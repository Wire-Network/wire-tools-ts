 ...
 * {@link planRegister} here is the typed convenience carrying the same action data.
 *
...
export namespace OperatorSteps {
  /** Input for {@link planRegister} — the generated `opreg::regoperator` data. */
  ...
  export function planRegister<C extends ClusterBuildContext = ClusterBuildContext>(
    actor: Report.Actor,
    name: string,
    description: string,
