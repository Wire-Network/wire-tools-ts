...
import { GetClusterConfigResponseSchemaCodec, GetClusterStateResponseSchemaCodec } from "../cluster/index.js"
import { LogReadResponseSchemaCodec, LogStatResponseSchemaCodec } from "../logs/index.js"
import { GetProcessLivenessResponseSchemaCodec, ListProcessesResponseSchemaCodec } from "../processes/index.js"
 ...
 */
export const PlainJsonRpcResponseCodecs: Partial<Record<HandlerURIType, SchemaCodec<unknown>>> = {
  ...
  [ApiPaths.Processes.Methods.GetLiveness]: GetProcessLivenessResponseSchemaCodec,
